...
def class_descr(classdescr, 
	...
	print("> Key Abilities: %s, %s, %s\n" (keyabilities1, keyabilities2, keyabilities3, keyabilities4))
	print("> Armor Proficiencies: %s, %s, %s, %s, %s" % (armorprof1, armorprof2, armorprof3, armorprof4, armorprof5, armorprof6, armorprof7, armorprof8))
	print("> Weapon Proficiencies: %s, %s, %s" % (weaponprof1, weaponprof2, weaponprof3, weaponprof4, weaponprof5))
	print("> Bonus to Defense: %s\n" % defbonus1, defbonus2, defbonus3)
	...
	print("> %s\n" % (trainedskill10))
	print("> Build Options: %s, %s" % (buildoption1, buildoption1))
	print("> %s have the following Class Features:" % )
	print("> %s : %s" (classfeat1, classfeatdescr1))
	print("> %s : %s" (classfeat2, classfeatdescr2))
	print("> %s : %s" (classfeat3, classfeatdescr3))
	print("> %s : %s\n" (classfeat4, classfeatdescr4))
...
class_descr(
			...
			channel_divinity_cleric, healers_lore, healing_word, ritual_casting, " ")
